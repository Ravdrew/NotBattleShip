...
public class BoatRunner extends Boat{
    ...
    public static void main(String[] args) {
        ...
        BoatRunner a = new BoatRunner(1, new Coordinates(0,0), 0, 9, 5, 2);
        ...
        barray[0] = new BoatRunner(1, new Coordinates(3,3), 2, 9, 5, 1);
        barray[1] = new BoatRunner(1, new Coordinates(2,2), 2, 9, 5, 1);
